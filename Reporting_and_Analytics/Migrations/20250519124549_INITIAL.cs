    ...
    public partial class INITIAL : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Particulars", x => x.transaction_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    report_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    particular_id = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IncomeStatements", x => x.report_id);
                    table.ForeignKey(
                        name: "FK_IncomeStatements_Particulars_particular_id",
                        column: x => x.particular_id,
